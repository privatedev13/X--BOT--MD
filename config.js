...
module.exports = {
	...
	AUDIO_DATA: process.env.AUDIO_DATA || "𝐀𝐍𝐉𝐀𝐍-𝐒𝐄𝐑-𝐁𝐎𝐓;𝐀𝐍𝐉𝐀𝐍;https://files.catbox.moe/ttdne9.jpg",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "𝐀𝐍𝐉𝐀𝐍-𝐒𝐄𝐑-𝐁𝐎𝐓;𝐀𝐍𝐉𝐀𝐍;https://files.catbox.moe/ttdne9.jpg",
	...
	PING: process.env.PING || "𝐀𝐍𝐉𝐀𝐍-𝐒𝐄𝐑-𝐁𝐎𝐓",
	...
	SESSION_ID: process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:c2ab755c978e7d4434a1aa711268ce6a",
	START_MSG: toBool(process.env.START_MSG || "true"),
	STICKER_DATA: process.env.STICKER_DATA || `𝐀𝐍𝐉𝐀𝐍-𝐒𝐄𝐑-𝐁𝐎𝐓`,
	SUDO: process.env.SUDO || "919242172548",
